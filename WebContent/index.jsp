        ...
        <ul>
            ...
            <li data-transition="random">
                ...
                <div class="sfb tp-caption"
                    ...
                    data-responsive="on">
                    <a href="page-portfolio-grid-fullwidth.html" class="wprt-button outline rounded-3px big">OUR PORTFOLIO</a>
                </div>
            </li>
            <!-- End Slide -->
            <!-- Slide -->
            <li data-transition="random">
                ...
                <div class="sfb tp-caption"
                    ...
                    data-actions='[{"event":"click","action":"scrollbelow","offset":"20px"}]'
                    data-responsive="on">
                    <a href="#" class="wprt-button big outline rounded-3px">QET A QUOTE</a>
                </div>
            </li>
            <!-- End Slide -->
            </ul>
